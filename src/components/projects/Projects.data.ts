export const projectData = [
    ...
    {
        name: 'Connect Audit Manager',
        start: 'Jan, 2017',
        end: 'Dec 2019',
        company: 'PWC / Infosys',
        personal: false,
        skills: ['Angular', 'Rxjs', 'Express js', 'Mongodb', 'Firebase', 'CSS', 'HTML', 'Cypress' , 'jest / jasmine', 'Azure'],
        description: 'PwC’s internal audit management solution provides complete process management and has modules of team head, manager and auditor information respectively for the entire audit lifecycle.'
    },
    {
        name: 'Quick Market Reports',
        start: 'Oct, 2014',
        end: 'Dec 2016',
        company: 'Bolas Intelli Solutions',
        personal: false,
        skills: ['Angular 1.6', 'PHP', 'Javascript', 'CSS', "HTML", 'NET', 'Jquery /AJAX', "XML"],
    ...
    },
    {
        ...
        company: 'Bolas Intelli Solutions',
        personal: false,
        skills: ['Angular 1.5', 'Jquery', 'backbonejs', 'CSS', 'HTML', 'PHP / Laravel', 'NET', 'MYsql', 'SQL', 'Quickblox'],
        description: 'The video calling app built with the help of QuickBlox enables users to engage in real-time, high-quality video calls across multiple platforms, providing a seamless and secure communication experience while incorporating features such as user authentication, signaling, media streaming, and push notifications, all designed to enhance usability, reliability, and user satisfaction'
    },
    {
        name: 'Smart Splitwise',
        start: 'Nov, 2020',
        end: 'N/A',
        company: 'Personal',
        personal: true,
